...
static uint32_t colors[][3] = {
    /* fg          bg          border    */
    [SchemeNorm] = { 0xbbb49dff, 0x1e2224ff, 0x49504fff }, // Vintage Bone, Abyss, Steel Shadow
    [SchemeSel]  = { 0xece6d9ff, 0x1e2224ff, 0xbbb49dff }, // Bleached Bone, Abyss, Vintage Bone
    [SchemeUrg]  = { 0x1e2224ff, 0xbbb49dff, 0xbbb49dff },
};
/* tagging */
...
static const Key keys[] = {
	...
	{ MODKEY,                    XKB_KEY_w,          spawn,            {.v = menucmd} },
        ...
        { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_D,          spawn,          {.v = rofifinder} },
        { MODKEY,                    XKB_KEY_b,          spawn,          {.v = browser} },
        { MODKEY,                    XKB_KEY_f,          spawn,          {.v = yazicmd} },
        { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_E,          spawn,          {.v = dolphin} },
        { MODKEY,                    XKB_KEY_e,          spawn,          {.v = zed} },
        { MODKEY,                    XKB_KEY_m,          spawn,          {.v = rmpccmd} },
        { MODKEY,                    XKB_KEY_c,          spawn,          {.v = cavacmd} },
        { MODKEY,                    XKB_KEY_z,          spawn,          {.v = nvimcmd} },
        { MODKEY,                    XKB_KEY_x,          spawn,          {.v = suwa_start} },
        { MODKEY|WLR_MODIFIER_SHIFT, XKB_KEY_X,          spawn,          {.v = suwa_stop} },
        ...
        { MODKEY,                    XKB_KEY_p,                    spawn, {.v = playpause} },
	{ MODKEY,                    XKB_KEY_Return,      spawn,            {.v = termcmd} },
        { MODKEY, XKB_KEY_s, spawn, SHCMD("grim ~/Pictures/$(date +%Y-%m-%d-%H%M%S)_screenshot.png") },
